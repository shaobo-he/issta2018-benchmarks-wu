...
//          const void *_src_cpy, size_t len) __attribute__((always_inline))
// {
//   uint8_t *dst_xor = _dst_xor;
//   uint8_t *srcdst_cpy = _srcdst_cpy;
//   const uint8_t *src_xor = _src_xor;
//   const uint8_t *src_cpy = _src_cpy;
//   uint8_t temp;
...
//   dst_xor = (uint8_t *)ldst_xor;
//   src_xor = (const uint8_t *)lsrc_xor;
//   srcdst_cpy = (uint8_t *)lsrcdst_cpy;
//   src_cpy = (const uint8_t *)lsrc_cpy;
...
//    CFB mode decryption.  */
// static inline void
// buf_xor_n_copy(void *_dst_xor, void *_srcdst_cpy, const void *_src, size_t len) __attribute__((always_inline))
// {
...
// static int bf_setkey (void *c, const uint8_t *key, unsigned keylen);
// static unsigned int encrypt_block (void *bc, uint8_t *outbuf, const uint8_t *inbuf);
// static unsigned int decrypt_block (void *bc, uint8_t *outbuf, const uint8_t *inbuf);
...
extern void _gcry_blowfish_amd64_encrypt_block(BLOWFISH_context *c, uint8_t *out,
					       const uint8_t *in);

extern void _gcry_blowfish_amd64_decrypt_block(BLOWFISH_context *c, uint8_t *out,
					       const uint8_t *in);

/* These assembly implementations process four blocks in parallel. */
extern void _gcry_blowfish_amd64_ctr_enc(BLOWFISH_context *ctx, uint8_t *out,
					 const uint8_t *in, uint8_t *ctr);

extern void _gcry_blowfish_amd64_cbc_dec(BLOWFISH_context *ctx, uint8_t *out,
					 const uint8_t *in, uint8_t *iv);

extern void _gcry_blowfish_amd64_cfb_dec(BLOWFISH_context *ctx, uint8_t *out,
					 const uint8_t *in, uint8_t *iv);
...
// static void
// do_encrypt_block (BLOWFISH_context *context, uint8_t *outbuf, const uint8_t *inbuf)
// {
// #ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
...
// static void
// do_decrypt_block (BLOWFISH_context *context, uint8_t *outbuf, const uint8_t *inbuf)
// {
// #ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
...
// static inline void
// blowfish_amd64_ctr_enc(BLOWFISH_context *ctx, uint8_t *out, const uint8_t *in,
//                        uint8_t *ctr)
// {
// #ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
...
// static inline void
// blowfish_amd64_cbc_dec(BLOWFISH_context *ctx, uint8_t *out, const uint8_t *in,
//                        uint8_t *iv)
// {
// #ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
...
// static inline void
// blowfish_amd64_cfb_dec(BLOWFISH_context *ctx, uint8_t *out, const uint8_t *in,
//                        uint8_t *iv)
// {
// #ifdef HAVE_COMPATIBLE_GCC_WIN64_PLATFORM_AS
...
// extern void _gcry_blowfish_arm_encrypt_block(BLOWFISH_context *c, uint8_t *out,
// 					       const uint8_t *in);

// extern void _gcry_blowfish_arm_decrypt_block(BLOWFISH_context *c, uint8_t *out,
// 					       const uint8_t *in);

//  These assembly implementations process two blocks in parallel. 
// extern void _gcry_blowfish_arm_ctr_enc(BLOWFISH_context *ctx, uint8_t *out,
// 					 const uint8_t *in, uint8_t *ctr);

// extern void _gcry_blowfish_arm_cbc_dec(BLOWFISH_context *ctx, uint8_t *out,
// 					 const uint8_t *in, uint8_t *iv);

// extern void _gcry_blowfish_arm_cfb_dec(BLOWFISH_context *ctx, uint8_t *out,
					 // const uint8_t *in, uint8_t *iv);
...
static void
blowfish_do_encrypt (BLOWFISH_context *bc, uint32_t *ret_xl, uint32_t *ret_xr )
{
#if BLOWFISH_ROUNDS == 16
...
// static void
// do_encrypt_block ( BLOWFISH_context *bc, uint8_t *outbuf, const uint8_t *inbuf )
// {
//   uint32_t d1, d2;
...
// static void
// do_decrypt_block (BLOWFISH_context *bc, uint8_t *outbuf, const uint8_t *inbuf)
// {
//   uint32_t d1, d2;
...
val_to_hidx(uint32_t val) __attribute__((always_inline))
{
...
add_val(struct hashset_elem hset[256], uint32_t val, int *midx,
	struct hashset_elem *mpool) __attribute__((always_inline))
{
...
static inline int
do_bf_setkey (const uint8_t *key, BLOWFISH_context *c, unsigned keylen) __attribute__((always_inline))
{
  ...
  for(i=0; i < BLOWFISH_ROUNDS+2; i += 2 )
    {
      blowfish_do_encrypt( c, &datal, &datar );
      c->p[i]   = datal;
      c->p[i+1] = datar;
    }
  for(i=0; i < 256; i += 2 )
  ...
  memset(hset, 0, sizeof(hset));
  memset(mempool, 0, sizeof(mempool[0]) * memidx);

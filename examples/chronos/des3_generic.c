 ...
 *
 */
inline int des3_ede_setkey(struct des3_ede_ctx *dctx, const uint8_t *key, unsigned int keylen) __attribute__((always_inline))
{
...
int main(int argc, char *argv[])
{
    ...
    {
    	key_len = 24;
    	printf("Warning: Only the first 24 bytes key is used!\n");
    }
 ...
 //    	printf("%02X",in[i]);
	...
	des3_ede_setkey(&ctx, in_key, key_len);
#ifdef gem5            
	m5_work_begin(0, 0);
	m5_reset_stats(0, 0);
#endif
